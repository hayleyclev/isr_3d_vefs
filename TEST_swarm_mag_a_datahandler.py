...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 29 23:31:41 2024
...
def collect_data(start_time, end_time):
    ...
    while current_time <= end_time:
        ...
        swarm_mag_a_data = lompe.Data(values = dB * 1e-9, coordinates = coords, datatype = 'space_mag_full', iweight=0.3)
