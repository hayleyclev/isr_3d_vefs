...
def collect_data(swarm_b_tii_fn, start_time, end_time, time_step, iweight):
    # Load CDF file
    v = cdflib.CDF(swarm_b_tii_fn)
    ...
    while current_time <= end_time:
        ...
        print("swarm b tii los shape: ", los.shape)
        print("swarm b tii vlos shape: ", vlos.shape)
        print("swarm b tii coords shape: ", coords.shape)

        swarm_b_tii_data.append(lompe.Data(vlos, coordinates=coords, LOS=los, datatype='convection', scale=None, iweight=iweight))

        current_time = next_time
        
    return swarm_b_tii_data
