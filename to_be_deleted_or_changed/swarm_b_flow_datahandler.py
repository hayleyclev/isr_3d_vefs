...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 19:52:06 2024
...
def collect_data(start_time, end_time):
    ...
    while current_time <= end_time:
        ...
        swarm_b_flow_data = lompe.Data(vlos, coordinates=coords, LOS=los, datatype='convection', scale=None)
