...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 00:16:55 2024
...
def collect_data(start_time, end_time):
    ...
    while current_time <= end_time:
        ...
        swarm_mag_b_data = lompe.Data(values = dB * 1e-9, coordinates = coords, datatype = 'space_mag_full', iweight=0.4)
