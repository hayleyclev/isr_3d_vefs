...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 15:51:10 2024
...
Parameters Out:
    - Lompe model object for Swarm B magnetometer data (gets used in pfrr_run_lompe.py)
...
def collect_data(start_time, end_time, time_step):
    ...
    swarm_b_mag_data_request = request.get_between(start_time, end_time)
    df = swarm_b_mag_data_request.as_dataframe()
    ...
    while current_time <= end_time:
        ...
        swarm_b_mag_data.append(lompe.Data(values=dB_chunk * 1e-9, coordinates=coords_chunk, datatype='space_mag_full', iweight=1.0))

        current_time = next_time
        

    # Returns the segmented, sorted, and appended data as a lompe model object
    return swarm_b_mag_data