...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 14:53:05 2024
...
Parameters Out:
    - Lompe model object for Swarm A magnetometer data (gets used in pfrr_run_lompe.py)
...
def collect_data(start_time, end_time, time_step):
    ...
    swarm_a_mag_data_request = request.get_between(start_time, end_time)
    df = swarm_a_mag_data_request.as_dataframe()
