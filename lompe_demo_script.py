...
event = '2017-06-16'
savepath = '/Users/hayleyclev/Desktop/lompe/demo/outputs'
...
pfisrfn = '/Users/hayleyclev/Desktop/AMISR/2017/lompe_test/20170616.001_lp_1min-fitcal.h5'
...
def prepare_data(t0, t1):
    ...
    pfisr_data = lompe.Data(vlos, coordinates = coords, LOS = los, datatype = 'convection', scale = 500)
