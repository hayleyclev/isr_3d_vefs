...
times = pd.date_range('2016-09-13 00:00', '2016-09-13 00:30', freq = '1Min') # 
...
with h5py.File(pfisrfn,"r") as h5: # read out data from synthetic data h5 file
    ...
    Vlos = h5['FittedParams/Fits'][:,:,:,-1,3] # Vlos fields from h5
...
for t in times[1:2]:
    ...
    gtg, ltl = model.run_inversion(l1 = 2, l2 = 1) # damping parameters - fine tune on own
