...
times = pd.date_range('2017-06-16 14:00', '2017-06-16 14:59', freq = '5Min') # no data in some minutes - figure that out
# DT currently doesn't matter - only selecting 1 timestamp based on t0
DT = timedelta(seconds = 5 * 60) # will select data from +- DT
